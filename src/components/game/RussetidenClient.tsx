        ...
        <>
            ...
            <section className="mx-auto mt-12 max-w-4xl rounded-[1.75rem] border border-border/70 bg-card/40 px-5">
              <p className="pt-5 text-sm text-muted-foreground">
                Vil dere ha flere råd for russetiden, ligger den lengre guiden
                her som en ekstra ressurs etter spillutvalget.
              </p>
              <Accordion type="single" collapsible>
                <AccordionItem value="russ-guide" className="border-none">
                  <AccordionTrigger className="py-4 text-left text-base font-semibold text-foreground hover:no-underline">
                    Les guide for russetiden
                  </AccordionTrigger>
                  <AccordionContent className="pb-5">
                    <article className="prose prose-invert lg:prose-lg max-w-none">
                      ...
                      <h3>Lek: Tikk-Takk-Kaos (Tick Tock)</h3>
                      <p>En intens konsentrasjonslek som alltid kollapser i latter. Dere trenger to små gjenstander, for eksempel en snusboks og en nøkkel. Lederen sender snusboksen til høyre og sier: Dette er en Tikk. Personen til høyre må spørre En hva, lederen svarer En Tikk, og gjenstanden sendes videre. Samtidig sendes den andre gjenstanden til venstre som En Takk. Når disse to gjenstandene krysser hverandre i sirkelen, kortslutter hjernen til folk fullstendig.</p>
                      ...
                      <h3>5. Samtykke er alt</h3>
                      <p>Dette er det absolutt viktigste punktet. Russetiden handler om å ha det gøy, men det må skje på en trygg måte. Husk at alle selskapsleker og all interaksjon, spesielt de som er flørtende eller utfordrende, krever tydelig og entusiastisk samtykke fra alle involverte. Nei er nei gjelder overalt, også i leken. Respekter hverandres grenser, og sørg for at alle er komfortable til enhver tid. En god fest er en trygg fest for alle.</p>
                    </article>
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
